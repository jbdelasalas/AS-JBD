...
export async function POST(request: NextRequest) {
  ...
  try {
    ...
    results.push('039 stock_adjustments.je_id: ok');
  } catch (e) { results.push(`039 stock_adjustments.je_id: ${(e as Error).message}`); }
  ...
  try {
    ...
    results.push('039 Inventory Adjustment account: ok');
  } catch (e) { results.push(`039 Inventory Adjustment account: ${(e as Error).message}`); }
