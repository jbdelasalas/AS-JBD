...
export async function POST(_req: NextRequest, { params }: { params: { id: string } }) {
  ...
  await query(`UPDATE order_ins SET status='voided', voided_by=$1, voided_at=now() WHERE id=$2`, [auth.userId, params.id]);
  await query(`INSERT INTO audit_log (user_id, company_id, action, entity_type, entity_id) VALUES ($1,$2,'void','order_in',$3)`,
