...
export async function POST(_req: NextRequest, { params }: { params: { id: string } }) {
  ...
  await query(`UPDATE sales_tally_sheets SET status='posted', posted_at=now() WHERE id=$1`, [params.id]);
  await query(`INSERT INTO audit_log (user_id, company_id, action, entity_type, entity_id) VALUES ($1,$2,'post','sales_tally',$3)`,
