...
export async function POST(_req: NextRequest, { params }: { params: { id: string } }) {
  ...
  await query(`UPDATE poultry_invoices SET status='voided' WHERE id=$1`, [params.id]);
  await query(`INSERT INTO audit_log (user_id, company_id, action, entity_type, entity_id) VALUES ($1,$2,'void','poultry_invoice',$3)`,
