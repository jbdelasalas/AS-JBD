...
const MODULES = [
  { href: '/dashboard/inventory/items',        label: 'Items',             desc: 'Manage SKUs, categories, costing method, and reorder levels.',     color: 'border-brand-200 bg-brand-50 text-brand-800' },
  { href: '/dashboard/inventory/stock-on-hand', label: 'Stock On Hand',    desc: 'View current balances and stock values by item and warehouse.',    color: 'border-slate-200 bg-slate-50 text-slate-800' },
  ...
  { href: '/dashboard/inventory/transfers',    label: 'Transfers',         desc: 'Move stock between warehouses with full in-transit tracking.',      color: 'border-violet-200 bg-violet-50 text-violet-800' },
...
export default function InventoryHomePage() {
  ...
  return (
    <div>
      ...
      <p className="mb-5 text-sm text-slate-600 dark:text-slate-400">Items, warehouses, stock movements, adjustments, transfers, and counts.</p>
