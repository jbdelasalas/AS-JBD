...
export default function BirHomePage() {
  return (
    <div>
      ...
      <p className="mb-6 text-sm text-slate-600 dark:text-slate-400">VAT, EWT, document series control, filing calendar.</p>
      ...
      <div className="rounded-lg border border-amber-200 bg-amber-50 p-4 text-sm text-amber-800">
        ...
        <p className="mt-1 text-xs leading-relaxed">
          ...
          <code className="rounded bg-white dark:bg-slate-900 px-1 py-0.5 font-mono text-[11px]">apps/api/src/modules/bir/README.md</code>{" "}
