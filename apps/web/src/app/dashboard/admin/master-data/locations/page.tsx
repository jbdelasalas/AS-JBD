...
interface Row { id: string; code: string; name: string; address: string | null; is_active: boolean; }
        ...
        <table className="min-w-full text-sm">
          ...
          <tbody>
            {loading ? (
              ...
              <tr><td colSpan={5} className="px-3 py-8 text-center text-xs text-slate-500">No locations. Add one above.</td></tr>
            ) : rows.map(r => (
              editId === r.id ? (
