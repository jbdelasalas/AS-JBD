...
const MODULES = [
  { href: '/dashboard/purchasing/suppliers', label: 'Suppliers',  desc: 'Manage vendor master records, TIN, payment terms, and EWT rates.',   color: 'border-brand-200 bg-brand-50 text-brand-800' },
